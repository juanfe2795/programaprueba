           ...
           <div class="modal-body">
				<form>
                    <div class="form-group">
                        <label for="nombre_egreso">Nombre Egreso</label>
                        <input wire:model="nombre_egreso" type="text" class="form-control" id="nombre_egreso" placeholder="Nombre Egreso">@error('nombre_egreso') <span class="error text-danger">{{ $message }}</span> @enderror
                    </div>
                    <div class="form-group">
